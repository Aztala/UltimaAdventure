...
namespace Server.Items
{
	...
	public class CraftAttributeInfo
	{
		...
		static CraftAttributeInfo()
		{
			...
			dullCopper.ArmorPhysicalResist = 12;
			...
			shadowIron.ArmorPhysicalResist = 4;
			shadowIron.ArmorFireResist = 2;
			shadowIron.ArmorEnergyResist = 10;
			...
			copper.ArmorPoisonResist = 10;
			copper.ArmorEnergyResist = 4;
			...
			valorite.ArmorPhysicalResist = 8;
			...
			nepturite.ArmorPhysicalResist = 16;
			nepturite.ArmorColdResist = 10;
			...
			steel.ArmorPhysicalResist = 12;
			steel.ArmorColdResist = 10;
			steel.ArmorPoisonResist = 10;
			steel.ArmorEnergyResist = 10;
			...
			brass.ArmorPhysicalResist = 16;
			brass.ArmorColdResist = 14;
			brass.ArmorPoisonResist = 14;
			brass.ArmorEnergyResist = 14;
			...
			mithril.ArmorPhysicalResist = 20;
			mithril.ArmorColdResist = 18;
			...
			dwarven.ArmorPhysicalResist = 40;
			dwarven.ArmorFireResist = 20;
			dwarven.ArmorColdResist = 20;
			...
			xormite.ArmorPhysicalResist = 20;
			xormite.ArmorColdResist = 18;
			xormite.ArmorPoisonResist = 18;
			xormite.ArmorFireResist = 18;
			xormite.ArmorEnergyResist = 24;
			...
			spined.ArmorPhysicalResist = 3; // 10
			...
			horned.ArmorPhysicalResist = 5; //15
			horned.ArmorColdResist = 5;
			horned.ArmorPoisonResist = 5;
			...
			barbed.ArmorPhysicalResist = 5; //20
			barbed.ArmorFireResist = 8;
			barbed.ArmorColdResist = 3;
			barbed.ArmorPoisonResist = 4;
			...
			necrotic.ArmorPhysicalResist = 5; //25
			necrotic.ArmorColdResist = 5;
			necrotic.ArmorPoisonResist = 10;
			necrotic.ArmorEnergyResist = 5;
			...
			volcanic.ArmorPhysicalResist = 8; //30
			volcanic.ArmorFireResist = 15;
			volcanic.ArmorPoisonResist = 4;
			...
			frozen.ArmorPhysicalResist = 8; //30
			frozen.ArmorColdResist = 15;
			...
			goliath.ArmorPhysicalResist = 15; //30
			goliath.ArmorFireResist = 5;
			goliath.ArmorColdResist = 5;
			goliath.ArmorEnergyResist = 5;
			...
			draconic.ArmorPhysicalResist = 5; //30
			draconic.ArmorFireResist = 15;
			draconic.ArmorPoisonResist = 5;
			draconic.ArmorEnergyResist = 5;
			...
			hellish.ArmorPhysicalResist = 5; //30
			hellish.ArmorColdResist = 5;
			hellish.ArmorPoisonResist = 5;
			hellish.ArmorEnergyResist = 15;
			...
			dinosaur.ArmorPhysicalResist = 10; //40
			dinosaur.ArmorFireResist = 10;
			dinosaur.ArmorColdResist = 10;
			dinosaur.ArmorPoisonResist = 10;
			...
			alien.ArmorPhysicalResist = 10; //45
			alien.ArmorFireResist = 5;
			alien.ArmorColdResist = 10;
			alien.ArmorPoisonResist = 10;
			alien.ArmorEnergyResist = 10;
			...
			red.ArmorPhysicalResist = 10;
			red.ArmorFireResist = 12;
			red.ArmorColdResist = 7;
			red.ArmorPoisonResist = 10;
			red.ArmorEnergyResist = 10;

			CraftAttributeInfo yellow = YellowScales = new CraftAttributeInfo();

			yellow.ArmorPhysicalResist = 9;
			yellow.ArmorFireResist = 9;
			yellow.ArmorColdResist = 9;
			yellow.ArmorPoisonResist = 9;
			yellow.ArmorEnergyResist = 9;
            yellow.ArmorGoldIncrease = 9;

            CraftAttributeInfo black = BlackScales = new CraftAttributeInfo();

			black.ArmorPhysicalResist = 12;
			black.ArmorFireResist = 10;
			black.ArmorColdResist = 10;
			black.ArmorPoisonResist = 10;
			black.ArmorEnergyResist = 10;

			CraftAttributeInfo green = GreenScales = new CraftAttributeInfo();

			green.ArmorPhysicalResist = 7;
			green.ArmorFireResist = 7;
			green.ArmorColdResist = 10;
			green.ArmorPoisonResist = 12;
			green.ArmorEnergyResist = 12;

			CraftAttributeInfo white = WhiteScales = new CraftAttributeInfo();

			white.ArmorPhysicalResist = 8;
			white.ArmorFireResist = 8;
			white.ArmorColdResist = 8;
			white.ArmorPoisonResist = 8;
			white.ArmorEnergyResist = 8;

			CraftAttributeInfo blue = BlueScales = new CraftAttributeInfo();

			blue.ArmorPhysicalResist = 8;
			blue.ArmorFireResist = 8;
			blue.ArmorColdResist = 10;
			blue.ArmorPoisonResist = 8;
			blue.ArmorEnergyResist = 8;

			CraftAttributeInfo dino = DinosaurScales = new CraftAttributeInfo();

			dino.ArmorPhysicalResist = 12;
			dino.ArmorFireResist = 8;
			dino.ArmorColdResist = 12;
			dino.ArmorPoisonResist = 10;
			dino.ArmorEnergyResist = 8;

			CraftAttributeInfo ashtree = AshTree = new CraftAttributeInfo();

			ashtree.ArmorPhysicalResist = 2; //10
			ashtree.ArmorFireResist = 2;
			...
			cherrytree.ArmorPhysicalResist = 2; //13
			cherrytree.ArmorFireResist = 3;
			cherrytree.ArmorColdResist = 3;
			cherrytree.ArmorPoisonResist = 3;
			cherrytree.ArmorEnergyResist = 2;
			...
			ebonytree.ArmorPhysicalResist = 6; //16
			ebonytree.ArmorFireResist = 5;
			...
			goldenoaktree.ArmorPhysicalResist = 5; //20
			goldenoaktree.ArmorFireResist = 5;
			goldenoaktree.ArmorColdResist = 5;
			goldenoaktree.ArmorEnergyResist = 5;
			...
			hickorytree.ArmorPhysicalResist = 10; //20
			goldenoaktree.ArmorColdResist = 10;
			...
			mahoganytree.ArmorPhysicalResist = 7; //23
			mahoganytree.ArmorFireResist = 6;
			mahoganytree.ArmorPoisonResist = 5;
			mahoganytree.ArmorEnergyResist = 5;
			...
			oaktree.ArmorPhysicalResist = 5; //26
			oaktree.ArmorColdResist = 10;
			oaktree.ArmorPoisonResist = 5;
			oaktree.ArmorEnergyResist = 6;
			...
			pinetree.ArmorPhysicalResist = 3; //26
			pinetree.ArmorFireResist = 10;
			...
			ghosttree.ArmorPhysicalResist = 8; //30
			ghosttree.ArmorFireResist = 3;
			ghosttree.ArmorColdResist = 8;
			ghosttree.ArmorPoisonResist = 8;
			...
			rosewoodtree.ArmorPhysicalResist = 8; //30
			rosewoodtree.ArmorFireResist = 8;
			...
			walnuttree.ArmorPhysicalResist = 10;//30
			walnuttree.ArmorColdResist = 8;
			walnuttree.ArmorPoisonResist = 8;
			...
			petrifiedtree.ArmorPhysicalResist = 15; //40
			petrifiedtree.ArmorColdResist = 5;
			petrifiedtree.ArmorPoisonResist = 10;
			...
			driftwoodtree.ArmorPhysicalResist = 10; //40
			driftwoodtree.ArmorColdResist = 10;
			driftwoodtree.ArmorPoisonResist = 15;
			...
			elventree.ArmorPhysicalResist = 15; //50
			elventree.ArmorColdResist = 10;
			elventree.ArmorPoisonResist = 10;
