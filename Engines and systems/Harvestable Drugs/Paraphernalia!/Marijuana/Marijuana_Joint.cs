...
namespace Server.Items.Crops
{
    ...
    public class PipeWeed_Joint : DrugSystem_Effect
    {
        [Constructable]
        public PipeWeed_Joint(): base(0x1420)
        {
        ...
        public PipeWeed_Joint(Serial serial): base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (pack != null && pack.ConsumeTotal(typeof(PipeWeed_Joint), 1) )
