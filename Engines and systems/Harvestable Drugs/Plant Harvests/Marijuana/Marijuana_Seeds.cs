...
{
    public class PipeWeed_Seed : DrugSystem_Engine
    {        
        public override bool CanGrowGarden { get { return true; } }

        [Constructable]
        public PipeWeed_Seed(): this(1)
        {
        }

        [Constructable]
        public PipeWeed_Seed(int amount): base(0x1AA2)
        {
            Name = "PipeWeed Seeds";
            Weight = 0.1;
            Hue = 0;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            Item item = new PipeWeed_Seedling(from);
            item.Location = m_pnt;
            item.Map = m_map;
        }

        public PipeWeed_Seed(Serial serial): base(serial)
        {
        }
