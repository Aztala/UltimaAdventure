			...
			{	
				if (!phylactery.Temporary) {
					...
					if (page == 2) {
						...
						this.AddLabel(360, 60, 0, "Total essence bpower: " + phylactery.TotalPower().ToString() + "/" + phylactery.GetRawPoints(from).ToString());
						this.AddLabel(360, 90, 0, "Soul Items:");
						this.AddLabel(400, 125, 0, "White Shard: 7500 SF");
						this.AddButton(360, 120, 11320, 11320, 24, GumpButtonType.Reply, 0);
						this.AddLabel(400, 155, 0, "Prismatic Shard: 7500 SF");
						this.AddButton(360, 150, 11320, 11320, 25, GumpButtonType.Reply, 0);
						this.AddLabel(400, 185, 0, "Blood Rune: 2500 SF");
						this.AddButton(360, 180, 11320, 11320, 26, GumpButtonType.Reply, 0);
						this.AddLabel(400, 215, 0, "Royal Blood Urn: 35000 SF");
						this.AddButton(360, 210, 11320, 11320, 27, GumpButtonType.Reply, 0);
						this.AddLabel(360, 245, 0, "Cosmetic Items:");
						this.AddLabel(400, 275, 0, "Orc Soul: 25000 SF");
						this.AddButton(360, 270, 11320, 11320, 28, GumpButtonType.Reply, 0);
					} else {
