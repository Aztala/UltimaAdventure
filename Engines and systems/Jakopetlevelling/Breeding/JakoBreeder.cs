    ...
    class JakoBreeder : AnimalTrainer
    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            if (from is PlayerMobile && from != null && dropped is BreedingParentTicket)
            {
                ...
                if ( (bt.DoneReal >= DateTime.Now) && (((Mobile)from).AccessLevel == AccessLevel.Player) )
                {
                ...
                if (bt.Creature.Female)
                {
                    ...
                    SetStats( baby1, bt.Creature, bt.OtherCreature );    

                    //uint tolevel = Convert.ToUInt32(Utility.RandomMinMax( Convert.ToInt32((Convert.ToDouble(baby1.MaxLevel) / 4)), Convert.ToInt32((Convert.ToDouble(baby1.MaxLevel / 2) ))));                  

                    //while (baby1.Level < tolevel)
                    //{
                    //    uint xp = baby1.ExpNeeded(baby1.Level + 1);
			         //   baby1.GainExp(null, xp, false);
                    //}
                    ...
                    if (bt.Twins)
                    {
                        ...
                        SetStats( baby2, bt.Creature, bt.OtherCreature );  
                        //uint tolevel2 = baby1.Level;   
					
                        //while (baby2.Level != tolevel2)
                        //{
                        //    uint xp = baby2.ExpNeeded(baby2.Level + 1);
                        //    baby2.GainExp(null, xp, false);
                        //}
        ...
        public void SetStats( Mobile baby, Mobile parent1, Mobile parent2 )
        {
            if (baby == null || parent1 == null || parent2 == null)
                return;

            Mobile statser = parent1;
            ...
            if (Utility.RandomDouble() > 0.33)
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).HitsMaxSeed = ((BaseCreature)statser).HitsMaxSeed;
                ((BaseCreature)baby).Hits = ((BaseCreature)baby).HitsMaxSeed;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).RawStr = ((BaseCreature)statser).RawStr;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).RawDex = ((BaseCreature)statser).RawDex;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).RawInt = ((BaseCreature)statser).RawInt;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).PoisonResistSeed = ((BaseCreature)statser).PoisonResistSeed;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).ColdResistSeed = ((BaseCreature)statser).ColdResistSeed;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).PhysicalResistanceSeed = ((BaseCreature)statser).PhysicalResistanceSeed;
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).FireResistSeed = ((BaseCreature)statser).FireResistSeed;    
            }
            ...
            if (Utility.RandomBool())
            {
                if (Utility.RandomBool())
                    statser = parent1;
                        ...
                        statser = parent2;
                ((BaseCreature)baby).EnergyResistSeed = ((BaseCreature)statser).EnergyResistSeed;    
            }     
