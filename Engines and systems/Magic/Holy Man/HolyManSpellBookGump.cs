	...
	public class HolyManSpellbookGump : Gump 
	{
		...
		public HolyManSpellbookGump( Mobile from, HolyManSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			else if ( page == 2 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Sends demons and the dead back to the realms of hell.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 3 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Absorbs mana from others and bestows it to the priest.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 4 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Temporarily imbues a weapon with holy powers.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 5 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Temporarily summons a hammer from the gods.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 6 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Destroys the darkness, allowing for one to see better.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 7 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>The priest is able to help those that are starving or thirsty.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 8 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Removes curses and other ailing effects.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 9 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Brings one back to life, or summons an orb to resurrect the priest later on.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 10 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Surrounds one with a holy aura that heals wounds much quicker.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 11 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>The gods grant the priest greater strength, speed, and intelligence.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 12 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Allows the priest to enter the realm of the dead, avoiding any harm.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 13 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Calls down a bolt from the heavens, doing double damage to demons and undead.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 14 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=#111111><BIG>Restores health and stamina to the weary.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
