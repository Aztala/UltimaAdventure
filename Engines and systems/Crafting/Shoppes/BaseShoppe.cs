...
namespace Server.Items
{
	...
	public class BaseShoppe : Item, ISecurable
	{
		...
		{
			if ( shoppe is MorticianShoppe ){ from.CheckSkill( SkillName.Forensics, (difficulty - 25), (difficulty + 25) ); from.CheckSkill( SkillName.Necromancy, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is HerbalistShoppe ){ from.CheckSkill( SkillName.Alchemy, (difficulty - 25), (difficulty + 25) ); from.CheckSkill( SkillName.AnimalLore, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is AlchemistShoppe ){ from.CheckSkill( SkillName.Alchemy, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is BlacksmithShoppe ){ from.CheckSkill( SkillName.Blacksmith, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is BowyerShoppe ){ from.CheckSkill( SkillName.Fletching, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is CarpentryShoppe ){ from.CheckSkill( SkillName.Carpentry, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is CartographyShoppe ){ from.CheckSkill( SkillName.Cartography, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is BakerShoppe ){ from.CheckSkill( SkillName.Cooking, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is LibrarianShoppe ){ from.CheckSkill( SkillName.Inscribe, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is TailorShoppe ){ from.CheckSkill( SkillName.Tailoring, (difficulty - 25), (difficulty + 25) ); }
			else if ( shoppe is TinkerShoppe ){ from.CheckSkill( SkillName.Tinkering, (difficulty - 25), (difficulty + 25) ); }
		}
			...
			public override void OnClick()
			{
				...
				PlayerMobile mobile = (PlayerMobile) m_Mobile;
				{
					if ( m_Shoppe.ShoppeGold > 0 )
					{
						...
						Titles.AwardFame( m_Mobile, (int)((double)m_Shoppe.ShoppeGold/15), true );

						int cash = (int)( m_Shoppe.ShoppeGold + (m_Shoppe.ShoppeGold * (barter / 100) ) );

						if (mobile.NormalMode)
						{
							...
							if (mobile.Karma >= 0)
							{
								Titles.AwardKarma( m_Mobile, (int)((double)cash/20), true );
		...
		public bool GetDelay()
		{
			...
			else if ( pm.NpcGuild == NpcGuild.MerchantsGuild && Utility.RandomDouble() > 0.80 )
				test = true;
