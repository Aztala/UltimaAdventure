    ...
    public class AttributeHandler
    {
        ...
        public static void Initialize()
        {
            ...
            Definitions.Add(new AttributeHandler(EnhanceType.AosArmorAttribute, "MageArmor", "Mage Armor",							1, 1, 250,
                armor, !weapon, !jewelry, !spellbook, !shield, !clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "RegenHits", "Hit Point Regeneration", 					25, 1, 10,
                armor, !weapon, !jewelry, !spellbook, !shield, clothing));
            ...
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "EnhancePotions", "Enhance Potions", 					25, 1, 2,
                !armor, !weapon, jewelry, !spellbook, !shield, clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "CastSpeed", "Faster Casting", 							20, 1, 20,
                !armor, !weapon, jewelry, spellbook, !shield, clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "CastRecovery", "Faster Cast Recovery", 					20, 1, 20,
                !armor, !weapon, jewelry, spellbook, !shield, clothing));
