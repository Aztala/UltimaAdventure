...
namespace Server
{
	public class MBConfirmSignupGump : Gump
	{
		...
		public MBConfirmSignupGump(Mobile from, GauntletMaster controller) : base(50, 50)
		{
			...
			AddBorderedText(35, y, 240, 20, String.Format("Entrance Cost: {0}", (int)(1000 * ( Math.Pow(1.15, (int)((PlayerMobile)from).LastGauntletLevel ) ) )), LabelColor32, BlackColor32);
			y += 20;
			...
			AddBorderedText(35, y, 190, 20, String.Format("Ruleset: {0}", "Monsters try and kill you"), LabelColor32, BlackColor32);
			y += 20;
							...
							case 3:
								{
									...
									{
										int cost = (int)(1000 * ( Math.Pow(1.15, (int)((PlayerMobile)m).LastGauntletLevel ) ) );
