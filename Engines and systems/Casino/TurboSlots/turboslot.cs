 ...
 * 
 * Usage: ]add TurboSlotsToken {uses} {hue}
 * -------------------------------------------------------------------
 * 
...
namespace Server.Items
{
	...
	#region Casino Token
	public class TurboSlotsToken : Item   // Free plays on Casino games that are aware of Tokens
	{

		[Constructable]
		public TurboSlotsToken() : this(10) { }

		[Constructable]
		public TurboSlotsToken(int NumCredits) : this(NumCredits, 56) { }

		[Constructable]
		public TurboSlotsToken(int NumCredits, int CreditHue)
			: base(10922)
		{
...
#endif
		public TurboSlotsToken(Serial serial)
			: base(serial)
		{
		}
