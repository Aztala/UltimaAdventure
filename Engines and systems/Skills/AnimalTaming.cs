				...
				protected override void OnTick()
				{
					...
					else if ( m_Count < m_MaxCount )
					{
						...
						else 
						{
							if (m_Tamer.Karma < 0)
							{
								...
								{
									case 0: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Come here, you little mongrel."  ) ); break;
									case 1: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Come on, tame already."  ) ); break;
									case 2: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Consider yourself lucky I don't hit TAB..."  ) ); break;
									case 3: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I'm just going to rename you and kill you."  ) ); break;
									case 4: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I bet the broker will pay well for you."  ) ); break;
									case 5: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Come... kill my enemies and make me rich."  ) ); break;
									case 6: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I'm too lazy to kill enemies myself, I need you to do it for me see?"  ) ); break;
									case 7: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I was just joking when I asked you to travel with me."  ) ); break;
									case 8: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "If you don't give me a gain you'll pay."  ) ); break;
									case 9: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "If you don't tame now I'll starve you for making me wait."  ) ); break;
									case 10: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "You might be worth more in hides and meat."  ) ); break;
							...
							else
							{
								switch ( Utility.Random( 11 ) )
								{
									case 0: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Take your time!  I want you to trust me."  ) ); break;
									case 1: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I will find you a nice home to live in."  ) ); break;
									case 2: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "What a beautiful creature you are!"  ) ); break;
									case 3: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Can you make that cute noise again?"  ) ); break;
									case 4: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I will care for you and grow with you."  ) ); break;
									case 5: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Together we will explore marvelous places!"  ) ); break;
									case 6: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "You and me, sitting on a tree... wait what?"  ) ); break;
									case 7: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I bet your fur is soft... can I touch it?"  ) ); break;
									case 8: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Consider coming with me, friend."  ) ); break;
									case 9: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "Out of all the creatures around me, I picked you my friend."  ) ); break;
									case 10: m_Tamer.PublicOverheadMessage( MessageType.Regular, 0x3B2, false, string.Format ( "I will train you to become a better creature."  ) ); break;
					...
					else
					{
						...
						if ( CheckMastery( m_Tamer, m_Creature ) || alreadyOwned || m_Tamer.CheckTargetSkill( SkillName.AnimalTaming, m_Creature, minSkill - 25.0, minSkill + 25.0 ) )
						{
							...
							{
								if ( m_Paralyzed )
									ScaleSkills( m_Creature, 0.75 ); // 86% of original skills if they were paralyzed during the taming
								else
