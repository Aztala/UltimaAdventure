	...
	public class Stealing
	{
		...
		private class StealingTarget : Target
		{
			...
			private Item TryStealItem( Item toSteal, ref bool caught, Mobile target )
			{
				...
				else if ( toSteal is Coffer )
				{
					...
					if ( Pilfer )
					{
						...
						else if ( m_Thief.CheckSkill( SkillName.Stealing, (Utility.RandomMinMax(0, 60)), 100 ) )
						{
							...
							Titles.AwardFame( m_Thief, (int)( (double)coffer.CofferGold / 10 ), true );
							Titles.AwardKarma( m_Thief, -( (int)((double)coffer.CofferGold / 5 )), true );
				...
				else if ( (toSteal.LootType == LootType.Newbied || toSteal.CheckBlessed( root ) || toSteal.CheckEnsouled())  )
				{
					m_Thief.SendLocalizedMessage( 502710 ); // You can't steal that!
			...
			protected override void OnTarget( Mobile from, object target )
			{
				...
				else if ( target is Mobile )
				{
					...
					if (target is BaseCreature && Utility.RandomDouble() < odds && !(((Mobile)target).Blessed) && ((Mobile)target).Fame != 0 && !(target is CloneCharacterOnLogout.CharacterClone) ) // player targetting a basecreature Final making it more fun to steal
					{
						...
						if (Stealing.CheckStealingTarget( (Mobile)target, false )) // check only
						{
									...
									else if (Math.Abs(((Mobile)target).Fame) <=2500)
										reward = Utility.RandomMinMax(100, 350); // 60% easy, 40% medium
									else if (Math.Abs(((Mobile)target).Fame) <=7000)
										reward = Utility.RandomMinMax(200, 400); // 25% easy, 62.5% medium, 12.5% rare
									else if (Math.Abs(((Mobile)target).Fame) <=13000)
										reward = Utility.RandomMinMax(300, 500); // 37.5 medium, 47% rare, 15% impossible
									else if (Math.Abs(((Mobile)target).Fame) <= 23000)
										reward = Utility.RandomMinMax(400, 500); // 70% rare, 30% impossible
									else if (Math.Abs(((Mobile)target).Fame) > 23001)
									...
									if (reward <= 250)// easy finds
									{
										switch ( Utility.Random( 16 ) ) // 
										{
												...
												case 10: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 1); break;
												case 11: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 1); break;
												case 12: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 1); break;
												case 13: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 1); break;
												case 14: rngitem = Loot.RandomInstrument(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 1); break;
										} 
									...
									else if (reward <=375) // medium finds
									{
										...
										{
												case 0: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 1: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 2: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 3: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 4: rngitem = Loot.RandomInstrument(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 5: rngitem = Loot.RandomQuiver(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 6: rngitem = Loot.RandomWand(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
												case 7: rngitem = Loot.RandomJewelry(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 5); break;
									...
									else if (reward <= 470) // rare finds
									{
										...
										{
												case 0: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 1: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 2: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 3: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 4: rngitem = Loot.RandomInstrument(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 5: rngitem = Loot.RandomQuiver(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 6: rngitem = Loot.RandomWand(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
												case 7: rngitem = Loot.RandomJewelry(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 10); break;
									...
									else if (reward <= 500)  // impossible finds
									{
										...
										{					
												...
												case 1: rngitem = Loot.RandomArmorOrShieldOrWeaponOrJewelryOrClothing(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 20); break;
												case 2: rngitem = Loot.RandomInstrument(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 20); break;
												case 3: rngitem = Loot.RandomQuiver(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 20); break;
												case 4: rngitem = Loot.RandomWand(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 20); break;
												case 5: rngitem = Loot.RandomJewelry(); Stealing.ItemMutate( from, (int)luckavg, rngitem, 20); break;
										}
									}
									...
									if (rngitem != null)
									{
										...
										if (stolen != null)
										{
											...
											Titles.AwardFame( from, (int)(Math.Abs(((Mobile)target).Fame)/25) , true );
				...
				if ( caught )
				{
					...
					else if ( root is Mobile )
					{
						...
						if ( mobRoot is PlayerMobile || mobRoot is BaseVendor || mobRoot is BaseBlue || ( !isindarkmoor && ((Mobile)m_Thief).Karma < 0 && ((Mobile)root).Karma > 0) )
							m_Thief.CriminalAction( true );
