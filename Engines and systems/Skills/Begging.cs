...
// Final ideas:
// begging works on players, grants up to 20% of the players gold
// begging has a higher chance of success and payout the closer you are to 0 karma/fame
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( targeted is Mobile )
				{
					...
					else if ( IsGonnaAttack(targ) && from != targ ) // BEG ENEMIES TO STOP ATTACKING YOU ////////////////////////////////////////
					{
						...
						if (from is PlayerMobile && !((PlayerMobile)from).HardCore)
						{
