...
namespace Server.Mobiles
{
	...
	{
		private WidowGate hergate = null;
		...
		public override void OnAfterSpawn()
		{
			...
			WidowGate hergate = new WidowGate();
			hergate.MoveToWorld(new Point3D(1091,1346,0),Map.Ilshenar);
			m_gate = hergate;
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			hergate = (WidowGate)reader.ReadItem();
			if (version >= 1)
