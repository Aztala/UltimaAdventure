...
{
	public class PortalGood : MonsterNest, IOneTime
	{
		...
		[Constructable]
		public PortalGood() : base()
		{
			m_OneTimeType = 5;
			Name = "A Balance Portal (double click to attack)";
			Hue = 0;
			MaxCount = 1;
			RespawnTime = TimeSpan.FromSeconds( 10.0 );
			HitsMax = 12500;
			Hits = 12500;
			NestSpawnType = "BlueGuard";
			ItemID = 0x3D5E;
			LootLevel = 0;
			RangeHome = 12;
			m_portaltick = 0;
		...
		public PortalGood( Serial serial ) : base( serial )
		{
		}
