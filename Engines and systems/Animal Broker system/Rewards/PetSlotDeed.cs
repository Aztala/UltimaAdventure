   ...
   public class PetSlotDeed : Item
   {
      ...
      PlayerMobile mobile = from as PlayerMobile;
       ...
       { 
         ...
         else if ( mobile.ExtraSlots == 5 )
         {
            mobile.SendMessage( "You are not allowed to use more than 5 deeds." );
         }
         else
         {
                        // mobile.FollowersMax += 1;
						 ((PlayerMobile)mobile).ExtraSlots += 1;
						 MaxFollowersIntelBased.Evaluate(mobile);
