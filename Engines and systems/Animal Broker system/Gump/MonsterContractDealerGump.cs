...
"<BASEFONT COLOR=YELLOW>Will you help me fill my contracts?<BR><BR>Oh, Thank you my friend. The contract will tell you which beasts to capture" + "</BODY>", false, true);
