	...
	public class HousePlacementEntry
	{
		...
		private static HousePlacementEntry[] m_ClassicHouses = new HousePlacementEntry[]
			{	// WIZARD ADDED SOME
				...
				new HousePlacementEntry( typeof( NewSmallWizardTower ), 				1030866, 	869, 	599, 	869, 	599, 	18, 325000, 	-2, 6, 	0, 	0x90),
				new HousePlacementEntry( typeof( NewWoodenMansion ), 					1030843, 	920, 	650, 	920, 	650, 	20, 375000, 	6, 	7, 	0, 	0x5A),
				new HousePlacementEntry( typeof( NewThreeStoryStoneVilla ), 			1030838, 	965, 	695, 	965, 	695, 	22, 520000, 	-6, 7, 	0, 	0x55),
				new HousePlacementEntry( typeof( Tower ), 								1011312, 	1476, 	1206, 	1476, 	1206, 	24, 750000, 	0, 	7, 	0, 	0x7A),
				new HousePlacementEntry( typeof( LargeTent ), 							1024851, 	1572, 	1302, 	1572, 	1302, 	28, 920000, 	1, 	13, 0, 	0x49),
				new HousePlacementEntry( typeof( Keep ), 								1011313, 	1847, 	1577, 	1847, 	1577, 	30, 100000, 	0, 	11, 0, 	0x7C),
				new HousePlacementEntry( typeof( Pyramid ), 							1024788, 	1856, 	1586, 	1856, 	1586, 	32, 120000, 	3, 	16, 0, 	0x48),
				new HousePlacementEntry( typeof( Castle ), 								1011314, 	2777, 	2507, 	2777, 	2507, 	34, 1800000, 	0, 	16, 0, 	0x7E),
				new HousePlacementEntry( typeof( Fortress ), 							1024869, 	4448, 	4178, 	4448, 	4178, 	36, 1900000, 	4, 	16, 0, 	0x4B)
			};
