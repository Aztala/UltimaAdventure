...
namespace Server.Mobiles
{
	...
	public class DemonKnight : BaseCursed
	{
		...
		private static Type[] m_ArtifactRarity11 = new Type[]
			{
				...
				typeof( Erotica ),
				typeof( FeverFall ),
				typeof( GlovesOfTheHardWorker ),
				typeof( HandsofTabulature ),
				typeof( Kamadon ),
				typeof( LaFemme ),
				typeof( EtherealHorse ),
				typeof( EtherealLlama ),
				typeof( EtherealOstard ),
				typeof( PurposeOfPain ),
				typeof( Revenge ),
				typeof( SatanicHelm ),
				typeof( StandStill ),
				typeof( TacticalMask ),
				typeof( ThickNeck ),
				typeof( ValasCompromise ),
				typeof( Valicious ),
				typeof( WizardsStrongArm ),
		...
		[Constructable]
		public DemonKnight() : base( AIType.AI_NecroMage, FightMode.Weakest, 10, 1, 0.2, 0.4 )
		{
