...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		...
		private static readonly ConstructCallback EnhancementDeed = new ConstructCallback( CreateEnhancementDeed );
		private static readonly ConstructCallback OneHandedDeed = new ConstructCallback( CreateOneHandedDeed );
		...
		private static Item CreateEnhancementDeed( int type )
		{
			return new EnhancementDeed();
		}
		
		private static Item CreateOneHandedDeed(int type )
		{

			return new OneHandedDeed();
		}
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup(  750, new RewardItem( 1, AncientHammer, 10 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup(  800, new RewardItem( 1, PowerScroll, 15 ) ),
					new RewardGroup(  850, new RewardItem( 1, AncientHammer, 15 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup(  900, new RewardItem( 1, PowerScroll, 20 ), new RewardItem( 1, OneHandedDeed ) ),
					new RewardGroup(  950, new RewardItem( 1, RunicHammer, 5 ), new RewardItem( 1, OneHandedDeed ) ),
					new RewardGroup( 1000, new RewardItem( 1, AncientHammer, 30 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 1050, new RewardItem( 1, RunicHammer, 6 ), new RewardItem( 1, OneHandedDeed ) ),
					new RewardGroup( 1100, new RewardItem( 1, AncientHammer, 60 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 1150, new RewardItem( 1, RunicHammer, 7 ), new RewardItem( 1, OneHandedDeed ) ),
					new RewardGroup( 1200, new RewardItem( 1, RunicHammer, 8 ), new RewardItem( 1, ItemBlessDeed ) )
				};
		}
	}
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		private static readonly ConstructCallback EnhancementDeed = new ConstructCallback( CreateEnhancementDeed );
		private static readonly ConstructCallback SalvageBag = new ConstructCallback( CreateSalvageBag );
		private static readonly ConstructCallback ItemBlessDeed = new ConstructCallback( CreateItemBlessDeed );
		...
		private static Item CreateSalvageBag( int type )
		{
			return new SalvageBag();
		}
			...
			Groups = new RewardGroup[]
				{
					...
					new RewardGroup( 400, new RewardItem( 2, PowerScroll, 5 ), new RewardItem( 3, Tapestry ), new RewardItem( 1, SalvageBag ) ),
					new RewardGroup( 450, new RewardItem( 1, BearRug ), new RewardItem( 1, SalvageBag ) ),
					new RewardGroup( 500, new RewardItem( 1, PowerScroll, 10 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 550, new RewardItem( 1, ClothingBlessDeed ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 575, new RewardItem( 1, PowerScroll, 15 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 600, new RewardItem( 1, RunicKit, 2 ), new RewardItem( 1, EnhancementDeed ) ),
					new RewardGroup( 650, new RewardItem( 1, PowerScroll, 20 ), new RewardItem( 1, ItemBlessDeed ) ),
					new RewardGroup( 700, new RewardItem( 1, RunicKit, 3 ), new RewardItem( 1, ItemBlessDeed ) )
				};
		}
	}
}