    ...
    class MyServerSettings
    {
		...
		public static int GetGoldCutRate( Mobile m, Item i )
		{
			...
			// SOME QUESTS
				...
				if ( evilloc )
				{
						if ((AetherGlobe.DoomCurse / 100000) >= 0.85)
							return 55;			
						if ((AetherGlobe.DoomCurse / 100000) >= 0.55)
							return 48;
						else if ((AetherGlobe.DoomCurse / 100000) >= 0.4)
							return 41;
						else if ((AetherGlobe.DoomCurse / 100000) >= 0.20)
							return 34;		
						else if ((AetherGlobe.DoomCurse / 100000) >= 0.00)
							return 27;
				}	
				else
				{
...
// Final added customizable caps for certain aos attributes
		...
		public static int EnhancePotionCap() {
			return 50;
		}
		...
		public static int curseincrease() // base for doomcurse calculation - higher means quicker increases, lower for less
		{
			return 3000;
		}
