...
/* Version 1.2; Verified 2.0 compatibility, added Sound 6/17/06 */
/* Version 1.3; Added MakesCriminal prop, with help from Sir_Britton 3/16/09 */
...
namespace Server.Items
{
    ...
    public class BaseTreasure : BaseAddon
    {
        ...
        public virtual void OnLoot( Mobile from )
        {
            ...
            if( !FindLooter( from ) )
            {
                ...
                int g = (int)(((double)Server.Misc.MyServerSettings.GetGoldCutRate(from, null) * 0.01)*(double)Utility.RandomMinMax( m_MinAmount, m_MaxAmount ));
    ...
    public class TreasureComponent : AddonComponent
    {
        ...
        {
            get { return ((BaseTreasure)base.Addon).MakesCriminal; }
            set { ((BaseTreasure)base.Addon).MakesCriminal = value; }
        }
