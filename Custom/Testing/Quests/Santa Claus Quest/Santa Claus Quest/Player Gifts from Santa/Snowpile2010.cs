...
{ 
   ...
   public class Snowpile2020 : Item 
   { 
      [Constructable] 
      public Snowpile2020() : base( 0x913 ) 
      { 
         Hue = 1151; 
      	Name="Snowball Launcher 2020";
      	LootType = LootType.Blessed;
	    m_NextAbilityTime = DateTime.Now;
   
      } 

      public Snowpile2020( Serial serial ) : base( serial ) 
      { 
      } 
private DateTime m_NextAbilityTime;
      ...
      { 
		...
		private Snowpile2020 m_Snow;

         public SnowTarget( Mobile thrower, Snowpile2020 snow ) : base ( 10, false, TargetFlags.None ) 
         { 
         	m_Thrower = thrower;
			m_Snow=snow;
         } 
