...
{
	public abstract class BaseToxicPotion : BasePotion
	{
		...
		public BaseToxicPotion( PotionEffect effect ) : base( 0xF0D, effect )
		{
		}

		public BaseToxicPotion( Serial serial ) : base( serial )
		{
		}
		...
		{
			private BaseToxicPotion m_Potion;

			public BaseToxicPotion Potion
			{
				get{ return m_Potion; }
			}

			public ThrowTarget( BaseToxicPotion potion ) : base( 12, true, TargetFlags.None )
			{
				m_Potion = potion;
			}
		...
		public void Explode( Mobile from, bool direct, Point3D loc, Map map )
		{
			...
			Effects.SendLocationEffect(loc, map, 0x36B0, 9, 10, 23, 0);
			Effects.SendLocationEffect(loc, map, 0x3728, 1, 10, 23, 1);
			int alchemyBonus = 0;
			...
			foreach ( object o in eable )
			{
				...
				else if ( o is BaseToxicPotion && o != this )
				{
					toExplode.Add( o );
				}
			}
			...
			for ( int i = 0; i < toExplode.Count; ++i )
			{
				...
				if ( o is Mobile )
				{
					...
					AOS.Damage( m, from, damage, 0, 0, 0, 0, 100 );
				}
				else if ( o is BaseToxicPotion )
				{
					BaseToxicPotion pot = (BaseToxicPotion)o;
