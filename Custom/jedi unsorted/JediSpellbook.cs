...
namespace Server.Items
{
	public class JediSpellbook : Spellbook
	{
		...
		[Constructable]
		public JediSpellbook( ulong content, Mobile gifted ) : base( content, 0xFFDB )
		{
			owner = gifted;
			page = 0;
			crystals = 0;
...
int color = Utility.RandomList( 0xB80, 0xB5E, 0xB39, 0xB3A, 0xA9F, 0x99E, 0x997, 0x8D9, 0x8DA, 0x8DB, 0x8DC, 0x8B9 );
			...
			else if ( MaterialInfo.IsMagicTalisman( dropped ) ){ dropped.ItemID = 0x556F; dropped.Name = "Jedi Exacron"; doJediEffect = true; }
