...
namespace Server.Items
{
	...
	public class FemaleCombativePlateChest : BaseArmor
	{
		...
		[Constructable]
		public FemaleCombativePlateChest() : base( 0x1C04 )
		{
			Weight = 4.0;
			Name = "Combative Plate Chest";
		...
		public FemaleCombativePlateChest( Serial serial ) : base( serial ) { }
