...
namespace Server.Items
{
	...
	public class CombativePlateArms : BaseArmor
	{
		...
		[Constructable]
		public CombativePlateArms() : base( 0x1410 )
		{
			Weight = 5.0;
			Name = "Combative Plate Arms";
		...
		public CombativePlateArms( Serial serial ) : base( serial ) { }
