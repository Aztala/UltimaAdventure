...
namespace Server.Items
{
	...
	public class CombativePlateGloves : BaseArmor
	{
		...
		[Constructable]
		public CombativePlateGloves() : base( 0x1414 )
		{
			Weight = 2.0;
			Name = "Combative Plate Gloves";
		...
		public CombativePlateGloves( Serial serial ) : base( serial ) { }
