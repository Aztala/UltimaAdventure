...
namespace Server.Items
{
	...
	public class CombativePlateLegs : BaseArmor
	{
		...
		[Constructable]
		public CombativePlateLegs() : base( 0x1411 )
		{
			Weight = 7.0;
			Name = "Combative Plate Legs";
		...
		public CombativePlateLegs( Serial serial ) : base( serial ) { }
