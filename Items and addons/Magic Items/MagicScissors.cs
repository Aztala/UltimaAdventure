	...
	public class MagicScissors : Item
	{
		...
		private class WearTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				{
					from.SendMessage( "You can only use these scissors on items in your pack." );
				}
							...
							iWear is MagicRobe )
				{
					if ( iWear.ItemID == 0x55DB ){ DoEffects = true; iWear.ItemID = 0x2B68; OldName = "royal loin cloth"; NewName = "loin cloth"; }
					...
					else if ( iWear.ItemID == 0x27E2 ){ DoEffects = true; iWear.ItemID = 0x2797; OldName = "ninja tabi"; NewName = "samurai tabi"; }
					...
					else if ( iWear.ItemID == 0x26AE ){ DoEffects = true; iWear.ItemID = 0x2FC6; OldName = "robe"; NewName = "spider robe"; }
					...
					else if ( iWear.ItemID == 0x230E || iWear.ItemID == 0x230D ){ DoEffects = true; iWear.ItemID = 0x2799; OldName = "gilded dress"; NewName = "robe"; }
					else if ( iWear.ItemID == 0x1F00 || iWear.ItemID == 0x1EFF ){ DoEffects = true; iWear.ItemID = 0x230E; OldName = "fancy dress"; NewName = "gilded dress"; }
					else if ( iWear.ItemID == 0x1f01 || iWear.ItemID == 0x1f02 ){ DoEffects = true; iWear.ItemID = 0x1F00; OldName = "dress"; NewName = "fancy dress"; }
					...
					else if ( iWear.ItemID == 0x2FB9 || iWear.ItemID == 0x3173 ){ DoEffects = true; iWear.ItemID = 0x3175; OldName = "assassin shroud"; NewName = "sorcerer robe"; }
					else if ( iWear.ItemID == 0x567E ){ DoEffects = true; iWear.ItemID = 0x2FB9; OldName = "pirate coat"; NewName = "assassin shroud"; }
					...
					else if ( iWear.ItemID == 0x2FBC ){ DoEffects = true; iWear.ItemID = 0x49C3; OldName = "pirate hat"; NewName = "stag mask"; }
					...
					else if ( iWear.ItemID == 0x3176 || iWear.ItemID == 0x3177 ){ DoEffects = true; iWear.ItemID = 5907; OldName = "cowl"; NewName = "floppy hat"; }
					...
					else if ( iWear.ItemID == 0x405 ){ DoEffects = true; iWear.ItemID = 0x407; OldName = "mask of the dead"; NewName = "wizard hood"; }
					...
					if ( DoEffects )
					{
						if ( Server.Misc.MaterialInfo.GetSpecialMaterialName( iWear ) != "" ){ iWear.Name = Server.Misc.MaterialInfo.GetSpecialMaterialName( iWear ) + NewName; }
						else if ( iWear.Name == null ){ iWear.Name = NewName; }
