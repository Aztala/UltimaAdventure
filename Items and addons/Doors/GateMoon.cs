...
namespace Server.Items
{
	public class GateMoon : Item
	{
		...
		public class MoonGateGump : Gump
		{
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				if ( info.ButtonID > 0 )
				{
					...
					if (gate1){gX = 2518; gY = 1529; gZ = 3; map = Map.Trammel;  }
					else if (gate2){gX = 3723; gY = 2155; gZ = 4; map = Map.Trammel;  }
					else if (gate3){gX = 1779; gY = 1714; gZ = 6; map = Map.Trammel;  }
					else if (gate4){gX = 3718; gY = 1136; gZ = 0; map = Map.Trammel;  }
					else if (gate5){gX = 4970; gY = 1297; gZ = 4; map = Map.Trammel;  }
					else if (gate6){gX = 3907; gY = 3962; gZ = 5; map = Map.Trammel;  }
					else if (gate7){gX = 2548; gY = 2685; gZ = 4; map = Map.Trammel;  }
					else if (gate8){gX = 963; gY = 514; gZ = 4; map = Map.Trammel;  }
					else if (gate9){gX = 1052; gY = 1570; gZ = 2; map = Map.Trammel;  }
					else if (gate10){gX = 1792; gY = 913; gZ = 27; map = Map.Trammel;  }
					else if (gate11){gX = 968; gY = 2726; gZ = 4; map = Map.Trammel;  }
					else if (gate12){gX = 4038; gY = 179; gZ = 2; map = Map.Trammel;  }
					else if (gate13){gX = 6092; gY = 3595; gZ = 4; map = Map.Trammel;  }
					else if (gate14){gX = 1249; gY = 3815; gZ = 2; map = Map.Trammel;  }
					else if (gate15){gX = 1017; gY = 546; gZ = 3; map = Map.Tokuno;  }
					else if (gate16){gX = 4199; gY = 2516; gZ = 7; map = Map.Felucca;  }
					else if (gate17){gX = 2497; gY = 1981; gZ = 5; map = Map.Felucca;  }
					else if (gate18){gX = 1045; gY = 2258; gZ = 6; map = Map.Felucca;  }
					else if (gate19){gX = 2350; gY = 3619; gZ = 6; map = Map.Felucca;  }
					else if (gate20){gX = 4276; gY = 1841; gZ = 16; map = Map.Felucca;  }
					else if (gate21){gX = 719; gY = 962; gZ = 6; map = Map.Felucca;  }
					else if (gate22){gX = 2876; gY = 733; gZ = 9; map = Map.Felucca;  }
					else if (gate23){gX = 1163; gY = 411; gZ = 5; map = Map.Malas;  }
					else if (gate24){gX = 1300; gY = 1372; gZ = 5; map = Map.Malas;  }
					else if (gate25){gX = 234; gY = 1333; gZ = 3; map = Map.Malas;  }
					else if (gate26){gX = 656; gY = 240; gZ = 3; map = Map.TerMur;  }
					else if (gate27){gX = 1112; gY = 1710; gZ = 20; map = Map.TerMur;  }
					else if (gate28){gX = 303; gY = 1269; gZ = 3; map = Map.TerMur;  }
					else if (gate29){gX = 6603; gY = 1082; gZ = 2; map = Map.Trammel;  }
					else if (gate30){gX = 6377; gY = 302; gZ = 15; map = Map.Felucca;  }
					else if (gate31){gX = 603; gY = 709; gZ = -38; map = Map.Ilshenar;  }
		...
		public static string GetGateName( int gate, Mobile m )
		{
			...
			else if ( gate == 9 && CharacterDatabase.GetDiscovered( m, "the Land of Sosaria" )){ sGate = "Sosaria - West"; }
