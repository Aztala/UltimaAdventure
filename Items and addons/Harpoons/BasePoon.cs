...
namespace Server.Items
{
	...
	public class BasePoon : Container, ICraftable
	{
		...
		public BasePoon() : this( 0x2B02 )
		{
		}

		public BasePoon( int itemID ) : base( itemID )
		{
			Weight = 2.0;
			Capacity = 500;
			Layer = Layer.Cloak;
		...
		public BasePoon( Serial serial ) : base( serial )
		{
		}

		public override void OnAfterDuped( Item newItem )
		{
			BasePoon quiver = newItem as BasePoon;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( ammo != null )
			{
				if ( ammo is HarpoonRope )
					list.Add( 3006987, "{0}\t{1}", ammo.Amount, Capacity ); // Ammo: ~1_QUANTITY~/~2_CAPACITY~ Harpoon Rope
