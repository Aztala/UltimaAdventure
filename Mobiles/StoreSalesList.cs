...
namespace Server.Mobiles
{
	...
	public class SBDoomVarietyDealer : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( ChargerOfTheFallen ), 1500000, 1, 0x2D9C, 0 ) );

				Add( new GenericBuyInfo( typeof( NightSightPotion ), 150, 10, 0xF06, 0 ) );
				Add( new GenericBuyInfo( typeof( AgilityPotion ), 150, 10, 0xF08, 0 ) );
				Add( new GenericBuyInfo( typeof( StrengthPotion ), 150, 10, 0xF09, 0 ) );
				Add( new GenericBuyInfo( typeof( RefreshPotion ), 150, 10, 0xF0B, 0 ) );
				Add( new GenericBuyInfo( typeof( LesserCurePotion ), 150, 10, 0xF07, 0 ) );
				Add( new GenericBuyInfo( typeof( LesserHealPotion ), 150, 10, 0xF0C, 0 ) );
				Add( new GenericBuyInfo( typeof( LesserPoisonPotion ), 150, 10, 0xF0A, 0 ) );
				Add( new GenericBuyInfo( typeof( LesserExplosionPotion ), 210, 10, 0xF0D, 0 ) );

				Add( new GenericBuyInfo( typeof( Bolt ), 10, Utility.Random( 400, 999 ), 0x1BFB, 0 ) );
				Add( new GenericBuyInfo( typeof( Arrow ), 8, Utility.Random( 400, 999 ), 0xF3F, 0 ) );

				Add( new GenericBuyInfo( typeof( BlackPearl ), 50, 999, 0xF7A, 0 ) ); 
				Add( new GenericBuyInfo( typeof( Bloodmoss ), 50, 999, 0xF7B, 0 ) ); 
				Add( new GenericBuyInfo( typeof( MandrakeRoot ), 30, 999, 0xF86, 0 ) ); 
				Add( new GenericBuyInfo( typeof( Garlic ), 30, 999, 0xF84, 0 ) ); 
				Add( new GenericBuyInfo( typeof( Ginseng ), 30, 999, 0xF85, 0 ) ); 
				Add( new GenericBuyInfo( typeof( Nightshade ), 30, 999, 0xF88, 0 ) ); 
				Add( new GenericBuyInfo( typeof( SpidersSilk ), 30, 999, 0xF8D, 0 ) ); 
				Add( new GenericBuyInfo( typeof( SulfurousAsh ), 30, 999, 0xF8C, 0 ) ); 

				Add( new GenericBuyInfo( typeof( BreadLoaf ), 70, 10, 0x103B, 0 ) );
				...
				if ( Core.AOS )
				{
					Add( new GenericBuyInfo( typeof( BatWing ), 30, 999, 0xF78, 0 ) );
					Add( new GenericBuyInfo( typeof( GraveDust ), 30, 999, 0xF8F, 0 ) );
					Add( new GenericBuyInfo( typeof( DaemonBlood ), 60, 999, 0xF7D, 0 ) );
					Add( new GenericBuyInfo( typeof( NoxCrystal ), 60, 999, 0xF8E, 0 ) );
					Add( new GenericBuyInfo( typeof( PigIron ), 50, 999, 0xF8A, 0 ) );
					Add( new GenericBuyInfo( typeof( NecromancerSpellbook ), 1150, 10, 0x2253, 0 ) );
				}

				Add( new GenericBuyInfo( typeof( RecallRune ), 150, 10, 0x1f14, 0 ) );
				Add( new GenericBuyInfo( typeof( FullMagerySpellbook ), 150000, 10, 0xEFA, 0 ) );
	...
	public class SBLotsOfArrows: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				Add( new GenericBuyInfo( typeof( ManyArrows100 ), 1200, 5, 0xF41, 0 ) );
				Add( new GenericBuyInfo( typeof( ManyBolts100 ), 1500, 5, 0x1BFD, 0 ) );
				Add( new GenericBuyInfo( typeof( ManyArrows1000 ), 15000, 10, 0xF41, 0 ) );
				Add( new GenericBuyInfo( typeof( ManyBolts1000 ), 17000, 10, 0x1BFD, 0 ) );
			}
		}
	...
	public class SBWoodenShields: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				Add( new GenericBuyInfo( typeof( WoodenShield ), 30, Utility.Random( 1,100 ), 0x1B7A, 0 ) );
			}
		}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenShield ), 100 ); } 
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public class SBSEFood: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Wasabi ), 2, Utility.Random( 1,100 ), 0x24E8, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Wasabi ), 2, Utility.Random( 1,100 ), 0x24E9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BentoBox ), 6, Utility.Random( 1,100 ), 0x2836, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BentoBox ), 6, Utility.Random( 1,100 ), 0x2837, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( GreenTeaBasket ), 2, Utility.Random( 1,100 ), 0x284B, 0 ) ); }
			}
		}
	...
	public class SBAxeWeapon: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( ExecutionersAxe ), 100 ); } 
	...
	public class SBAnimalTrainer : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( HitchingPost ), 10000, Utility.Random( 1,3 ), 0x14E7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MonsterContractBook ), 10000, Utility.Random( 1,3 ), 0x2259, 0 ) ); }
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( PetDyeTub ), 100000, Utility.Random( 1,3 ), 0x0012, 0 ) ); }
	...
	public class SBArchitect : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				Add( new GenericBuyInfo( typeof( InteriorDecorator ), 100, Utility.Random( 1,100 ), 0x1EBA, 0 ) );
				Add( new GenericBuyInfo( typeof( HousePlacementTool ), 50, Utility.Random( 1,100 ), 0x14F0, 0 ) );
				...
				if ( Server.Items.MovingBox.IsEnabled() ){ Add( new GenericBuyInfo( typeof( MovingBox ), 500, Utility.Random( 1,100 ), 0xE3D, 0xAC0 ) ); }
				if ( Server.Items.BasementDoor.IsEnabled() ){ Add( new GenericBuyInfo( typeof( BasementDoor ), 2500, Utility.Random( 1,100 ), 0x02C1, 0 ) ); }
				Add( new GenericBuyInfo( typeof( house_sign_sign_post_a ), 5, Utility.Random( 1,100 ), 2967, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_post_b ), 5, Utility.Random( 1,100 ), 2970, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_merc ), 10, Utility.Random( 1,100 ), 3082, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_armor ), 10, Utility.Random( 1,100 ), 3008, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_bake ), 10, Utility.Random( 1,100 ), 2980, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_bank ), 10, Utility.Random( 1,100 ), 3084, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_bard ), 10, Utility.Random( 1,100 ), 3004, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_smith ), 10, Utility.Random( 1,100 ), 3016, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_bow ), 10, Utility.Random( 1,100 ), 3022, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_ship ), 10, Utility.Random( 1,100 ), 2998, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_fletch ), 10, Utility.Random( 1,100 ), 3006, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_heal ), 10, Utility.Random( 1,100 ), 2988, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_inn ), 10, Utility.Random( 1,100 ), 2996, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_gem ), 10, Utility.Random( 1,100 ), 3010, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_book ), 10, Utility.Random( 1,100 ), 2966, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_mage ), 10, Utility.Random( 1,100 ), 2990, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_necro ), 10, Utility.Random( 1,100 ), 2811, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_supply ), 10, Utility.Random( 1,100 ), 3020, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_herb ), 10, Utility.Random( 1,100 ), 3014, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_pen ), 10, Utility.Random( 1,100 ), 3000, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_sew ), 10, Utility.Random( 1,100 ), 2982, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_tavern ), 10, Utility.Random( 1,100 ), 3012, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_tinker ), 10, Utility.Random( 1,100 ), 2984, 0 ) );
				Add( new GenericBuyInfo( typeof( house_sign_sign_wood ), 10, Utility.Random( 1,100 ), 2992, 0 ) );
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( StoneWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RedWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MarbleWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BrownWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BlackWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodWellDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MedCaseSouthAddonDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MedCaseEastAddonDeed ), 5000, 1, 0xF3A, 0xB97 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SmallCaseAddonDeed ), 2500, 1, 0xF3A, 0xB97 ) ); }
			}
		}
	...
	public class SBSailor : SBInfo
	{
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041205", typeof( SmallBoatDeed ), 9500, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
			} 
		} 
	...
	public class SBKungFu: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( MysticSpellbook ), 140, 20, 0x1A97, 0xB61 ) );
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 6, Utility.Random( 1,100 ), 0x103B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, Utility.Random( 1,100 ), 0x103C, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ApplePie ), 7, Utility.Random( 1,100 ), 0x1041, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Cake ), 13, Utility.Random( 1,100 ), 0x9E9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Muffins ), 3, Utility.Random( 1,100 ), 0x9EA, 0 ) ); }
				Add( new GenericBuyInfo( typeof( SackFlour ), 5, Utility.Random( 1,100 ), 0x1039, 0 ) ); 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( FrenchBread ), 5, Utility.Random( 1,100 ), 0x98C, 0 ) ); }
             	if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Cookies ), 3, Utility.Random( 1,100 ), 0x160b, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CheesePizza ), 8, 10, 0x1040, 0 ) ); } // OSI just has Pizza
				if ( MyServerSettings.SellChance() ){Add (new GenericBuyInfo( typeof( BowlFlour ), 7, Utility.Random( 1,100 ), 0xA1E, 0 ) ); }
			} 
		} 
		...
		{ 
			public InternalSellInfo() 
			{ 
				if ( MyServerSettings.BuyChance() ){Add( typeof( BreadLoaf ), 3 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( FrenchBread ), 1 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Cake ), 5 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Cookies ), 3 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Muffins ), 2 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( CheesePizza ), 4 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( ApplePie ), 5 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( PeachCobbler ), 5 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Quiche ), 6 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Dough ), 4 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Pitcher ), 5 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SackFlour ), 1 ); }  
	...
	public class SBBanker : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( "Interest Bag (Good)", typeof( InterestBag ), 500, 1, 0xE76, 0xABE ) ); 
				Add( new GenericBuyInfo( "Interest Bag (Evil)", typeof( EvilInterestBag ), 500, 1, 0xE76, 0xABE ) ); 
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Drums ), 21, Utility.Random( 1,100 ), 0x0E9C, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Tambourine ), 21, Utility.Random( 1,100 ), 0x0E9E, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LapHarp ), 21, Utility.Random( 1,100 ), 0x0EB2, 0 ) ); } 
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Lute ), 21, Utility.Random( 1,100 ), 0x0EB3, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BambooFlute ), 21, Utility.Random( 1,100 ), 0x2805, 0 ) ); }
	...
	public class SBBarkeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Milk, 7, Utility.Random( 1,100 ), 0x9F0, 0 ) ); }
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 6, Utility.Random( 1,100 ), 0x103B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CheeseWheel ), 21, Utility.Random( 1,100 ), 0x97E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CookedBird ), 17, Utility.Random( 1,100 ), 0x9B7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LambLeg ), 8, Utility.Random( 1,100 ), 0x160A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCarrots ), 3, Utility.Random( 1,100 ), 0x15F9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCorn ), 3, Utility.Random( 1,100 ), 0x15FA, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfLettuce ), 3, Utility.Random( 1,100 ), 0x15FB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfPeas ), 3, Utility.Random( 1,100 ), 0x15FC, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( EmptyPewterBowl ), 2, Utility.Random( 1,100 ), 0x15FD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PewterBowlOfCorn ), 3, Utility.Random( 1,100 ), 0x15FE, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PewterBowlOfLettuce ), 3, Utility.Random( 1,100 ), 0x15FF, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PewterBowlOfPeas ), 3, Utility.Random( 1,100 ), 0x1600, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PewterBowlOfFoodPotatos ), 3, Utility.Random( 1,100 ), 0x1601, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfStew ), 3, Utility.Random( 1,100 ), 0x1604, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfTomatoSoup ), 3, Utility.Random( 1,100 ), 0x1606, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ApplePie ), 7, Utility.Random( 1,100 ), 0x1041, 0 ) ); } //OSI just has Pie, not Apple/Fruit/Meat
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfCarrots ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfCorn ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfLettuce ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfPeas ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( EmptyPewterBowl ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( PewterBowlOfCorn ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( PewterBowlOfLettuce ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( PewterBowlOfPeas ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( PewterBowlOfFoodPotatos ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfStew ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfTomatoSoup ), 1 ); } 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BreadLoaf ), 3 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( CheeseWheel ), 12 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Ribs ), 6 ); } 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Banana ), 1 ); } 
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Bacon ), 7, Utility.Random( 1,100 ), 0x979, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Ham ), 26, Utility.Random( 1,100 ), 0x9C9, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Sausage ), 18, Utility.Random( 1,100 ), 0x9C0, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RawChickenLeg ), 6, Utility.Random( 1,100 ), 0x1607, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RawBird ), 9, Utility.Random( 1,100 ), 0x9B9, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RawLambLeg ), 9, Utility.Random( 1,100 ), 0x1609, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( RawRibs ), 16, Utility.Random( 1,100 ), 0x9F1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ButcherKnife ), 13, Utility.Random( 1,100 ), 0x13F6, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Cleaver ), 13, Utility.Random( 1,100 ), 0xEC3, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SkinningKnife ), 13, Utility.Random( 1,100 ), 0xEC4, 0 ) ); } 
			} 
		} 
		...
		{ 
			public InternalSellInfo() 
			{ 
				if ( MyServerSettings.BuyChance() ){Add( typeof( RawRibs ), 8 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( RawLambLeg ), 4 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( RawChickenLeg ), 3 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( RawBird ), 4 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Bacon ), 3 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Sausage ), 9 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Ham ), 13 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( ButcherKnife ), 7 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( Cleaver ), 7 ); }  
				if ( MyServerSettings.BuyChance() ){Add( typeof( SkinningKnife ), 7 ); }  
			} 
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, Utility.Random( 1,100 ), 0x103B, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, Utility.Random( 1,100 ), 0x103C, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ApplePie ), 7, Utility.Random( 1,100 ), 0x1041, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Cake ), 13, Utility.Random( 1,100 ), 0x9E9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Muffins ), 3, Utility.Random( 1,100 ), 0x9EA, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CheeseWheel ), 21, Utility.Random( 1,100 ), 0x97E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CookedBird ), 17, Utility.Random( 1,100 ), 0x9B7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LambLeg ), 8, Utility.Random( 1,100 ), 0x160A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ChickenLeg ), 5, Utility.Random( 1,100 ), 0x1608, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCarrots ), 3, Utility.Random( 1,100 ), 0x15F9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCorn ), 3, Utility.Random( 1,100 ), 0x15FA, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfLettuce ), 3, Utility.Random( 1,100 ), 0x15FB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfPeas ), 3, Utility.Random( 1,100 ), 0x15FC, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfStew ), 3, Utility.Random( 1,100 ), 0x1604, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfTomatoSoup ), 3, Utility.Random( 1,100 ), 0x1606, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RoastPig ), 106, Utility.Random( 1,100 ), 0x9BB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SackFlour ), 3, Utility.Random( 1,100 ), 0x1039, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RollingPin ), 2, Utility.Random( 1,100 ), 0x1043, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( FlourSifter ), 2, Utility.Random( 1,100 ), 0x103E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1044567", typeof( Skillet ), 3, Utility.Random( 1,100 ), 0x97F, 0 ) ); }
		...
		{ 
			...
			{ 
				if ( MyServerSettings.BuyChance() ){Add( typeof( CheeseWheel ), 12 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( CookedBird ), 8 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( RoastPig ), 53 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Cake ), 5 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SackFlour ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( BreadLoaf ), 2 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( ChickenLeg ), 3 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( LambLeg ), 4 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Skillet ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( FlourSifter ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( RollingPin ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Muffins ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( ApplePie ), 3 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfCarrots ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfCorn ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfLettuce ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfPeas ), 1 ); } 
	...
	{ 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Milk, 7, Utility.Random( 1,100 ), 0x9AD, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Grapes ), 3, Utility.Random( 1,100 ), 0x9D1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Apple ), 3, Utility.Random( 1,100 ), 0x9D0, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SheafOfHay ), 2, Utility.Random( 1,100 ), 0xF36, 0 ) ); }
			} 
		} 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Peach ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Pear ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SheafOfHay ), 1 ); } 
			} 
		} 
	} 
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RawFishSteak ), 3, Utility.Random( 1,100 ), 0x97A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 1,100 ), 0x9CC, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 1,100 ), 0x9CD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 1,100 ), 0x9CE, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 1,100 ), 0x9CF, 0 ) ); }
	...
	public class SBGlassblower : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Jar ), 5, Utility.Random( 1,100 ), 0x10B4, 0 ) ); } 
				if ( 1 > 0 ){Add( new GenericBuyInfo( "Crafting Glass With Glassblowing", typeof( GlassblowingBook ), 10637, Utility.Random( 1,100 ), 0xFF4, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( "Finding Glass-Quality Sand", typeof( SandMiningBook ), 10637, Utility.Random( 1,100 ), 0xFF4, 0 ) ); }
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 
				Add( new GenericBuyInfo( "special beard dye", typeof( SpecialBeardDye ), 500, Utility.Random( 1,100 ), 0xE26, 0 ) );
				Add( new GenericBuyInfo( "special hair dye", typeof( SpecialHairDye ), 500, Utility.Random( 1,100 ), 0xE26, 0 ) );
	...
	public class SBInnKeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LambLeg ), 8, Utility.Random( 1,100 ), 0x160A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ChickenLeg ), 5, Utility.Random( 1,100 ), 0x1608, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Ribs ), 7, Utility.Random( 1,100 ), 0x9F2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCarrots ), 3, Utility.Random( 1,100 ), 0x15F9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfCorn ), 3, Utility.Random( 1,100 ), 0x15FA, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfLettuce ), 3, Utility.Random( 1,100 ), 0x15FB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WoodenBowlOfPeas ), 3, Utility.Random( 1,100 ), 0x15FC, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Grapes ), 3, Utility.Random( 1,100 ), 0x9D1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Apple ), 3, Utility.Random( 1,100 ), 0x9D0, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Banana ), 2, Utility.Random( 1,100 ), 0x171F, 0 ) ); }
	...
	public class SBMapmaker : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BlankScroll ), 12, Utility.Random( 1,100 ), 0xEF3, 0 ) ); }
				if ( MyServerSettings.SellCommonChance() ){Add( new GenericBuyInfo( typeof( MasterSkeletonsKey ), Utility.Random( 250,1000 ), 25, 0x410B, 0 ) ); }
			}
		}
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 
				Add( new GenericBuyInfo( typeof( SackFlour ), 3, Utility.Random( 1,100 ), 0x1039, 0 ) );
				Add( new GenericBuyInfo( typeof( SheafOfHay ), 2, Utility.Random( 1,100 ), 0xF36, 0 ) );
			} 
		} 
	...
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Arrow ), 2, Utility.Random( 1,100 ), 0xF3F, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Bolt ), 5, Utility.Random( 1,100 ), 0x1BFB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Backpack ), 100, Utility.Random( 1,100 ), 0x53D5, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ThrowingWeapon ), 2, Utility.Random( 20, 120 ), 0x52B2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 6, Utility.Random( 1,100 ), 0x103B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LambLeg ), 8, Utility.Random( 1,100 ), 0x160A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ChickenLeg ), 5, Utility.Random( 1,100 ), 0x1608, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CookedBird ), 17, Utility.Random( 1,100 ), 0x9B7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( BeverageBottle ), BeverageType.Ale, 7, Utility.Random( 1,100 ), 0x99F, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BagOfNecroReagents ), 2000, 5, 0xE76, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BagOfReagents ), 2000, 5, 0xE76, 0 ) ); }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	public class SBBasement : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1060834", typeof( Engines.Plants.PlantBowl ), 2, Utility.Random( 1,100 ), 0x15FD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Arrow ), 1, Utility.Random( 20,100 ), 0xF3F, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Bolt ), 2, Utility.Random( 20,100 ), 0x1BFB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Backpack ), 100, Utility.Random( 1,100 ), 0x53D5, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Pouch ), 6, Utility.Random( 1,100 ), 0xE79, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Bag ), 6, Utility.Random( 1,100 ), 0xE76, 0xABE ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Candle ), 6, Utility.Random( 1,100 ), 0xA28, 0 ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SmallBagBall ), 3, Utility.Random( 1,100 ), 0x2256, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LargeBagBall ), 3, Utility.Random( 1,100 ), 0x2257, 0 ) ); }
				Add( new GenericBuyInfo( typeof( BagOfNecroReagents ), 500, 1, 0xE76, 0 ) ); 
				Add( new GenericBuyInfo( typeof( BagOfReagents ), 500, 1, 0xE76, 0 ) ); 
	...
	public class SBSage: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( WeaponAbilityBook ), 5, Utility.Random( 1,100 ), 0x2254, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnLeatherBook ), 5, Utility.Random( 1,100 ), 0x4C60, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnMiscBook ), 5, Utility.Random( 1,100 ), 0x4C5D, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnMetalBook ), 5, Utility.Random( 1,100 ), 0x4C5B, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnWoodBook ), 5, Utility.Random( 1,100 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnReagentsBook ), 5, Utility.Random( 1,100 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnGraniteBook ), 5, Utility.Random( 1,100 ), 0x4C5C, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnScalesBook ), 5, Utility.Random( 1,100 ), 0x4C60, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTailorBook ), 5, Utility.Random( 1,100 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTraps ), 5, Utility.Random( 1,100 ), 0xFF2, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( SwordsAndShackles ), 50, Utility.Random( 1,100 ), 0x529D, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( CBookDruidicHerbalism ), 50, Utility.Random( 1,100 ), 0x2D50, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( CBookNecroticAlchemy ), 50, Utility.Random( 1,100 ), 0x2253, 0x4AA ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( AlchemicalElixirs ), 50, Utility.Random( 1,100 ), 0x2219, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( AlchemicalMixtures ), 50, Utility.Random( 1,100 ), 0x2223, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BookOfPoisons ), 50, Utility.Random( 1,100 ), 0x2253, 0x4F8 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( WorkShoppes ), 50, Utility.Random( 1,100 ), 0x2259, 0xB50 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTitles ), 5, Utility.Random( 1,100 ), 0xFF2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ScribesPen ), 8, Utility.Random( 1,100 ), 0x2051, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BlankScroll ), 5, Utility.Random( 1,100 ), 0x0E34, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Monocle ), 24, Utility.Random( 1,25 ), 0x2C84, 0 ) ); }
	...
	public class SBSECook: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Wasabi ), 2, Utility.Random( 1,100 ), 0x24E8, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Wasabi ), 2, Utility.Random( 1,100 ), 0x24E9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SushiRolls ), 3, Utility.Random( 1,100 ), 0x283E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( SushiPlatter ), 3, Utility.Random( 1,100 ), 0x2840, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( GreenTea ), 3, Utility.Random( 1,100 ), 0x284C, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MisoSoup ), 3, Utility.Random( 1,100 ), 0x284D, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( WhiteMisoSoup ), 3, Utility.Random( 1,100 ), 0x284E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( RedMisoSoup ), 3, Utility.Random( 1,100 ), 0x284F, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( AwaseMisoSoup ), 3, Utility.Random( 1,100 ), 0x2850, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BentoBox ), 6, Utility.Random( 1,100 ), 0x2836, 0 ) ); }
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( Wasabi ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( BentoBox ), 3 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( GreenTea ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SushiRolls ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SushiPlatter ), 2 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( MisoSoup ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( RedMisoSoup ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( WhiteMisoSoup ), 1 ); } 
				if ( MyServerSettings.BuyChance() ){Add( typeof( AwaseMisoSoup ), 1 ); } 
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public class SBShipwright : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041206", typeof( SmallDragonBoatDeed ), 11000, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041207", typeof( MediumBoatDeed ), 12000, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041208", typeof( MediumDragonBoatDeed ), 13000, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041209", typeof( LargeBoatDeed ), 14000, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( "1041210", typeof( LargeDragonBoatDeed ), 15000, Utility.Random( 1,100 ), 0x14F3, 0x5BE ) ); }
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( DockingLantern ), 58, Utility.Random( 1,100 ), 0x40FF, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Sextant ), 13, Utility.Random( 1,100 ), 0x1057, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( GrapplingHook ), 58, Utility.Random( 1,100 ), 0x4F40, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BoatStain ), 26, Utility.Random( 1,100 ), 0x14E0, 0 ) ); }
			}
	...
	public class SBTavernKeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Jug ), BeverageType.Cider, 13, Utility.Random( 1,100 ), 0x9C8, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Milk, 7, Utility.Random( 1,100 ), 0x9F0, 0 ) ); }
				if ( 1 > 0 ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Ale, 11, Utility.Random( 1,100 ), 0x1F95, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Cider, 11, Utility.Random( 1,100 ), 0x1F97, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Liquor, 11, Utility.Random( 1,100 ), 0x1F99, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Wine, 11, Utility.Random( 1,100 ), 0x1F9B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new BeverageBuyInfo( typeof( Pitcher ), BeverageType.Water, 11, Utility.Random( 1,100 ), 0x1F9D, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BreadLoaf ), 6, Utility.Random( 1,100 ), 0x103B, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( CheeseWheel ), 21, Utility.Random( 1,100 ), 0x97E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CookedBird ), 17, Utility.Random( 1,100 ), 0x9B7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LambLeg ), 8, Utility.Random( 1,100 ), 0x160A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ChickenLeg ), 5, Utility.Random( 1,100 ), 0x1608, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Ribs ), 7, Utility.Random( 1,100 ), 0x9F2, 0 ) ); }
	...
	public class SBNecromancer : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MageEye ), 2, Utility.Random( 10,150 ), 0xF19, 0xB78 ) ); }
				Add( new GenericBuyInfo( typeof( CorruptedMoonStone ), 5000, 5, 0xF8B, 0 ) );
				Add( new GenericBuyInfo( typeof( BagOfNecroReagents ), 225, 10, 0xE76, 0 ) );
	...
	public class SBMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( BagOfReagents ), 200, 10, 0xE76, 0 ) ); 
	...
	public class SBBuyArtifacts: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AbysmalGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AcidProofRobe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Aegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngelicEmbrace ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngeroftheGods ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Annihilation ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneCap ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneShield ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcanicRobe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticBeacon ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticDeathDealer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfNobility ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfNobility ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheHarrower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfToxicity ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AuraOfShadows ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BalancingDeed ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BlazeOfDeath ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BookOfKnowledge ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowOfTheJukaKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfHealth ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheElements ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheVile ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BreathOfTheDead ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BurglarsBandana ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Calm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandelabraOfSouls ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CavortingClub ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CircletOfTheSorceress ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfBane ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfFire ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ColdBlood ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrimsonCincture ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrownOfTalKeesh ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkGuardiansChest ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkLordsPitchfork ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkNeck ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DeathsMask ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineCountenance ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DjinnisRing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DreadPirateHat ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresCollar ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresShield ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringBoxSet ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfHealth ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfProtection ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheElements ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheMagician ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheVile ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ElvenQuiver ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EmbroideredOakLeafCloak ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EnchantedTitanLegBone ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EternalFlame ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EvilMageGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FalseGodsScepter ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FangOfRactus ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FesteringWound ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fortifiedarms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FortunateBlades ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Frostbringer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FurCapeOfTheSorceress ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fury ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GauntletsOfNobility ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GeishasObi ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GladiatorsCollar ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlassSword ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfCorruption ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfRegeneration ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheHarrower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfThePugilist ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GuantletsOfAnger ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GwennosHarp ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HatOfTheMagi ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HeartOfTheLion ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HellForgedArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsArmPlates ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsBreastplate ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsLegging ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsPlateHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolySword ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersHeaddress ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Indecency ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsResolution ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( IolosLute ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsCollar ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JadeScimitar ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JesterHatofChuckles ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JinBaoriOfGoodFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KamiNarisIndestructableDoubleAxe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegacyOfTheDreadLord ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfBane ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfDeceit ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfEnlightenment ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfFire ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfFortune ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfInsight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfNobility ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheHarrower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LieutenantOfTheBritannianRoyalGuard ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LongShot ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyEarrings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyNecklace ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LunaLance ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MadmansHatchet ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagesBand ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansIllusion ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansMempo ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MarbleShield ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MauloftheBeast ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WizardsPants ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightBracers ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightLegs ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MinersPickaxe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NightsKiss ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NordicVikingSword ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxBow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxNightlight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxRangersHeavyCrossbow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OblivionsNeedle ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcChieftainHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcishVisage ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnamentOfTheMagician ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnateCrownOfTheHarrower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Pestilence ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PixieSwatter ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearMask ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PowerSurge ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Quell ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfBlight ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfElements ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfFire ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfIce ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfInfinity ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfLightning ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( QuiverOfRage ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RamusNecromanticScalpel ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Retort ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RighteousAnger ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfHealth ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheElements ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheMagician ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheVile ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEclipse ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEquinox ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTreason ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalArchersBow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsChestplate ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardSurvivalKnife ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamaritanRobe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamuraiHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SerpentsFang ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowBlade ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerCap ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShaminoCrossbow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShieldOfInvulnerability ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShimmeringTalisman ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShroudOfDeciet ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SoulSeeker ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SpiritOfTheTotem ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SprintersSandals ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfPower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfTheMagi ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Subdue ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SwiftStrike ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TalonBite ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheBeserkersMaul ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDryadBow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDragonSlayer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheRobeOfBritanniaAri ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheTaskmaster ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TitansHammer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemArms ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGloves ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGorget ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemLeggings ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemOfVoid ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemTunic ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TownGuardsHalberd ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfAegis ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfBane ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfFire ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheHarrower ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VampiricDaisho ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VioletCourage ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VoiceOfTheFallenKing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WarriorsClasp ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WeaponRenamingTool ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WildfireBow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Windsong ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WrathOfTheDryad ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( YashimotosHatsuburi ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ZyronicClaw ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EverlastingLoaf ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EverlastingBottle ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearCape ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearBoots ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Excalibur ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KodiakBearMask ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Stormbringer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesShield ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesSpear ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffofSnakes ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AilricsLongbow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LargeBagofHolding ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MediumBagofHolding ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SmallBagofHolding ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BagOfHolding ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BootsofHermes ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BeltofHercules ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsFeatheredHat ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsBow ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AxeoftheMinotaur ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowofthePhoenix ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsRobe ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsHat ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsStaff ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HammerofThor ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansSword ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansHelm ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SinbadsSword ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GiantBlackjack ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleCold ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleFire ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandlePoison ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleEnergy ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleWizard ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleNecromancer ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TorchOfTrapFinding ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RodOfResurrection ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTeleportation ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MaulOfTheTitans ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfBrilliance ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfDexterity ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GemOfSeeing ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DaggerOfVenom ), Utility.Random( 25000,35000 ) ); } 
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ColoringBook ), Utility.Random( 25000,35000 ) ); } 
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				...
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( PianoAddonDeed ), Utility.Random( 75000,100000 ), 1, 0x14F0, 0 ) ); }
	...
	public class SBSailorGuild : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( RawFishSteak ), 3, Utility.Random( 50,200 ), 0x97A, 0 ) );
				Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 50,200 ), 0x9CC, 0 ) );
				Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 50,200 ), 0x9CD, 0 ) );
				Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 50,200 ), 0x9CE, 0 ) );
				Add( new GenericBuyInfo( typeof( Fish ), 6, Utility.Random( 50,200 ), 0x9CF, 0 ) );
	...
	{ 
		...
		{ 
			public InternalSellInfo() 
			{
				...
				Add( typeof( ExecutionersAxe ), 100 );
