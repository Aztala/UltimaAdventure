...
namespace Server.Mobiles
{
	public class AnimalTrainer : BaseVendor
	{
		...
		{
			if( e.Mobile.InRange( this, 4 ) && !e.Handled )
			{
				if ( e.HasKeyword( 0x0008 ) ) // *stable*
				{
					e.Handled = true;
				...
				else if ( e.HasKeyword( 0x0009 ) ) // *claim*
				{
					e.Handled = true;
				...
				else if ( Insensitive.Contains( e.Speech, "find" ) || Insensitive.Contains( e.Speech, "fetch" ) )
				{
						Say("*sigh*");
