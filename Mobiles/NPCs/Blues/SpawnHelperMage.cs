	...
	{ 
		...
		public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			if ((m is PlayerMobile) && (m.AccessLevel == AccessLevel.Player))
			{
				...
				{
					if ( !m.Hidden && this.Combatant == null && DateTime.Now >= m_NextTalk ) // check if its time to talk
					{
		...
		[Constructable] 
		public SpawnHelperMage() : base( AIType.AI_Mage2, FightMode.Closest, 25, 1, 0.4, 0.3 ) 
		{ 
            Title = "[BEC-Mage]";
