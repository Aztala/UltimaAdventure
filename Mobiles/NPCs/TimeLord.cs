	...
	public class TimeLord : BasePerson
	{
      ...
      { 
		...
		public override void OnSpeech( SpeechEventArgs e ) 
		{
			...
			{
				if (  Insensitive.Contains( e.Speech, "buy" ) || Insensitive.Contains( e.Speech, "list" ) )
				{
					Say("Yes Mortal, I can help you with a 'spike' or a 'shard' of the balance."); 			
				}
				if (  Insensitive.Contains( e.Speech, "spike" ) )
				{
					...
					if (mobile.BalanceEffect >= 2500 || mobile.BalanceEffect <= -2500)
					{
						...
						Say("I have many devices you can 'buy' from me.  Go on with your petty plans."); 
				...
				if (  Insensitive.Contains( e.Speech, "shard" ) )
				{
					...
					if (mobile.BalanceEffect >= 5000 || mobile.BalanceEffect <= -5000)
					{
						...
						Say("Here is another device, mortal.  Go on with your petty plans."); 
				...
				else if (  Insensitive.Contains( e.Speech, "platu verrata narghbrl" ) ) // Clatu Verrata narghbrl for evil
				{
					...
					Say("Take this, you'll need it. If you want more, I will provide some to you for a cost, simply come to me and ask for a spike.");
