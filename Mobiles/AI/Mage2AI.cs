...
namespace Server.Mobiles
{
	public class Mage2AI : BaseAI
	{
        ...
        private Spell HealBackUp()
        {
            ...
            m_NextCastTime = DateTime.Now + CastDelay();
        ...
        public override bool DoActionCombat()
        {
            ...
            if (((m_Mobile.LastMoveTime + TimeSpan.FromSeconds(1.0)) < DateTime.Now) || m_Mobile.AIFullSpeedActive)
            {
            ...
            if (m_Mobile.Spell == null && DateTime.Now > m_NextCastTime && m_Mobile.InRange(m_Mobile.Combatant, Core.ML ? 10 : 12))
            {
