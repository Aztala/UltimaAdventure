...
{
	public class LightElfMinstrel : BaseCreature
	{
		private DateTime m_NextPickup;

		[Constructable]
		public LightElfMinstrel() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			SpeechHue = Server.Misc.RandomThings.GetSpeechHue();

			switch ( Utility.RandomMinMax( 0, 4 ) )
			{
				case 0: Title = "the Elven bard"; break;
				case 1: Title = "the Elven minstrel"; break;
				case 2: Title = "the Elven troubadour"; break;
				case 3: Title = "the Elven musician"; break;
				case 4: Title = "the Elven balladeer"; break;
			}
		...
		public LightElfMinstrel( Serial serial ) : base( serial )
		{
		}
